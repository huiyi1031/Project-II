...
export class OccupantService {
  ...
  getAllOccupants(filter?: string): Observable<Occupant[]> {
    let params = new HttpParams();
    if (filter && filter !== 'All') params = params.set('roleType', filter);
    return this.http.get<Occupant[]>(`${this.base}/Occupants`, { params });
  }
  ...
  removeFamilyMember(occupantID: number): Observable<void>   { return this.http.delete<void>(`${this.base}/Occupants/family/${occupantID}`); }
